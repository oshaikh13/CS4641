...
class RewardingFrozenLakeEnv(discrete.DiscreteEnv):
    ...
    def __init__(self, desc=None, map_name="4x4", rewarding=True, step_reward=-0.1, hole_reward=-1, goal_reward=1, transition_prob=.2, is_slippery=True):
                    ...
                    if letter in b'GH':
                        ...
                        if is_slippery:
                            for b in [(a - 1) % 4, a, (a + 1) % 4]:
                                ...
                                prob = 1.0 - transition_prob if b == a else transition_prob / 2.0
